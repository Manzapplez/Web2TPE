...
Para desplegar el sitio usamos **XAMPP**, en un servidor con Apache y MySQL
El archivo **.sql** en el repositorio se importa en phpMyAdmin, nosotros utilizamos el nombre **"web2_tpe"** como indica el archivo
